...
a persistence unit "acPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ac/pom.xml":
...
artifact ("ac.war") is already built. You can build
